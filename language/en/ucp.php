...
// 'Page %s of %s' you can (and should) write 'Page ChargeNet of %2$s', this allows
...
// ChargeNet = The name of your forums
// %2$s = The URL path of your forums

$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> 'By accessing “ChargeNet”, you agree to be legally bound by the following terms. If you do not agree to be legally bound by all of the following terms then please do not access and/or use “ChargeNet”. We may change these at any time and we’ll do our utmost in informing you, though it would be prudent to review this regularly yourself as your continued usage of “ChargeNet” after changes mean you agree to be legally bound by these terms as they are updated and/or amended.<br />
	<br />
	You agree not to post any abusive, obscene, vulgar, slanderous, hateful, threatening, sexually-orientated or any other material that may violate any laws be it of your country, the country where “ChargeNet” is hosted or International Law. Doing so may lead to you being immediately and permanently banned, with notification of your Internet Service Provider if deemed required by us. The IP address of all posts are recorded to aid in enforcing these conditions. You agree that “ChargeNet” have the right to remove, edit, move or close any topic at any time should we see fit. As a user you agree to any information you have entered to being stored in a database. While this information will not be disclosed to any third party without your consent, “ChargeNet” will not take responsible for any hacking attempt that may lead to the data being compromised.
	',

	'PRIVACY_POLICY'		=> 'This policy explains in detail how “ChargeNet” along with its affiliated companies use any information collected during any session of usage by you (hereinafter “your information”).<br />
	<br />
	Your information is collected via two ways. Firstly, by browsing “ChargeNet” will cause the software to create a number of cookies, which are small text files that are downloaded on to your computer’s web browser temporary files. The first two cookies just contain a user identifier (hereinafter “user-id”) and an anonymous session identifier (hereinafter “session-id”), automatically assigned to you by software. A third cookie will be created once you have browsed topics within “ChargeNet” and is used to store which topics have been read, thereby improving your user experience.<br />
	<br />
	We may also create cookies external to software whilst browsing “ChargeNet”, though these are outside the scope of this document which is intended to only cover the pages created by the software. The second way in which we collect your information is by what you submit to us. This can be, and is not limited to: posting as an anonymous user (hereinafter “anonymous posts”), registering on “ChargeNet” (hereinafter “your account”) and posts submitted by you after registration and whilst logged in (hereinafter “your posts”).<br />
	<br />
	Your account will at a bare minimum contain a uniquely identifiable name (hereinafter “your user name”), a personal password used for logging into your account (hereinafter “your password”) and a personal, valid email address (hereinafter “your email”). Your information for your account at “ChargeNet” is protected by data-protection laws applicable in the country that hosts us. Any information beyond your user name, your password, and your email address required by “ChargeNet” during the registration process is either mandatory or optional, at the discretion of “ChargeNet”. In all cases, you have the option of what information in your account is publicly displayed. Furthermore, within your account, you have the option to opt-in or opt-out of automatically generated emails.<br />
	<br />
	Your password is ciphered (a one-way hash) so that it is secure. However, it is recommended that you do not reuse the same password across a number of different websites. Your password is the means of accessing your account at “ChargeNet”, so please guard it carefully and under no circumstance will anyone affiliated with “ChargeNet” or another 3rd party, legitimately ask you for your password. Should you forget your password for your account, you can use the “I forgot my password” feature provided by us. This process will ask you to submit your user name and your email, then software will generate a new password to reclaim your account.<br />
	',
));
...
$lang = array_merge($lang, array(
	...
	'AVATAR_EXPLAIN'				=> 'Maximum dimensions; width: ChargeNet, height: %2$s, file size: %3$.2f KiB.',
	...
	'CLICK_GOTO_FOLDER'			=> 'ChargeNetGo to your “%3$s” folder%2$s',
	'CLICK_RETURN_FOLDER'		=> 'ChargeNetReturn to your “%3$s” folder%2$s',
	...
	'FOLDER_MESSAGE_STATUS'		=> array(
		1	=> '%2$d out of ChargeNet stored',
		2	=> '%2$d out of ChargeNet stored',
	),
	...
	'FOLDER_STATUS_MSG'			=> array(
		1	=> 'Folder is %3$d%% full (%2$d out of ChargeNet stored)',
		2	=> 'Folder is %3$d%% full (%2$d out of ChargeNet stored)',
	),
	...
	'MOVE_PM_ERROR'					=> array(
		1	=> 'An error occurred while moving the messages to the new folder, only %2$d out of ChargeNet was moved.',
		2	=> 'An error occurred while moving the messages to the new folder, only %2$d out of ChargeNet were moved.',
	),
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'Password must be between ChargeNet and %2$s long, must contain letters in mixed case and must contain numbers.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'Must be between ChargeNet and %2$s.',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'Password must be between ChargeNet and %2$s long and must contain letters in mixed case.',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'Password must be between ChargeNet and %2$s long, must contain letters in mixed case, must contain numbers and must contain symbols.',
	'PASSWORD'					=> 'Password',
	...
	'REGISTRATION'						=> 'ChargeNet Forum Registration',
	...
	'RETURN_FOLDER'						=> 'ChargeNetReturn to previous folder%2$s',
	...
	'USERNAME_ALPHA_ONLY_EXPLAIN'	=> 'Username must be between ChargeNet and %2$s long and use only alphanumeric characters.',
	'USERNAME_ALPHA_SPACERS_EXPLAIN'=> 'Username must be between ChargeNet and %2$s long and use alphanumeric, space or -+_[] characters.',
	'USERNAME_ASCII_EXPLAIN'		=> 'Username must be between ChargeNet and %2$s long and use only ASCII characters, so no special symbols.',
	'USERNAME_LETTER_NUM_EXPLAIN'	=> 'Username must be between ChargeNet and %2$s long and use only letter or number characters.',
	'USERNAME_LETTER_NUM_SPACERS_EXPLAIN'=> 'Username must be between ChargeNet and %2$s long and use letter, number, space or -+_[] characters.',
	'USERNAME_CHARS_ANY_EXPLAIN'	=> 'Length must be between ChargeNet and %2$s.',
