...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'david63.emaillist.admin.controller' => 'getDavid63_Emaillist_Admin_ControllerService',
            ...
            'kinerity.bestanswer.main.controller' => 'getKinerity_Bestanswer_Main_ControllerService',
            'log' => 'getLogService',
            ...
            'paybas.quicklogin.listener' => 'getPaybas_Quicklogin_ListenerService',
            ...
            'vse.topicpreview.data' => 'getVse_Topicpreview_DataService',
            'vse.topicpreview.display' => 'getVse_Topicpreview_DisplayService',
            'vse.topicpreview.listener' => 'getVse_Topicpreview_ListenerService',
            'vse.topicpreview.trim_tools' => 'getVse_Topicpreview_TrimToolsService',
            'vse.topicpreview.ucp_listener' => 'getVse_Topicpreview_UcpListenerService',
        );
    ...
    /**
     * Gets the 'david63.emaillist.admin.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \david63\emaillist\controller\admin_controller A david63\emaillist\controller\admin_controller instance.
     */
    protected function getDavid63_Emaillist_Admin_ControllerService()
    {
        return $this->services['david63.emaillist.admin.controller'] = new \david63\emaillist\controller\admin_controller($this->get('config'), $this->get('dbal.conn'), $this->get('request'), $this->get('template'), $this->get('user'), $this);
    }
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'root', '', 'phpbb_vega', '', false, false);
    ...
    /**
     * Gets the 'kinerity.bestanswer.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \kinerity\bestanswer\event\listener A kinerity\bestanswer\event\listener instance.
     */
    protected function getKinerity_Bestanswer_ListenerService()
    {
        return $this->services['kinerity.bestanswer.listener'] = new \kinerity\bestanswer\event\listener($this->get('auth'), $this->get('dbal.conn'), $this->get('controller.helper'), $this->get('request'), $this->get('template'), $this->get('user'), './', 'php', 'phpbb_');
    }

    /**
     * Gets the 'kinerity.bestanswer.main.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \kinerity\bestanswer\controller\main_controller A kinerity\bestanswer\controller\main_controller instance.
     */
    protected function getKinerity_Bestanswer_Main_ControllerService()
    {
        return $this->services['kinerity.bestanswer.main.controller'] = new \kinerity\bestanswer\controller\main_controller($this->get('auth'), $this->get('dbal.conn'), $this->get('request'), $this->get('user'), './', 'php', 'phpbb_');
    }
    ...
    /**
     * Gets the 'paybas.quicklogin.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \paybas\quicklogin\event\listener A paybas\quicklogin\event\listener instance.
     */
    protected function getPaybas_Quicklogin_ListenerService()
    {
        return $this->services['paybas.quicklogin.listener'] = new \paybas\quicklogin\event\listener($this->get('auth.provider_collection'), $this->get('config'), $this->get('template'), $this->get('user'), './', 'php');
    }
    ...
    /**
     * Gets the 'phpbb.boardannouncements.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbb\boardannouncements\controller\controller A phpbb\boardannouncements\controller\controller instance.
     */
    protected function getPhpbb_Boardannouncements_ControllerService()
    {
        return $this->services['phpbb.boardannouncements.controller'] = new \phpbb\boardannouncements\controller\controller($this->get('config'), $this->get('config_text'), $this->get('dbal.conn'), $this->get('request'), $this->get('user'));
    }

    /**
     * Gets the 'phpbb.boardannouncements.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbb\boardannouncements\event\listener A phpbb\boardannouncements\event\listener instance.
     */
    protected function getPhpbb_Boardannouncements_ListenerService()
    {
        return $this->services['phpbb.boardannouncements.listener'] = new \phpbb\boardannouncements\event\listener($this->get('cache.driver'), $this->get('config'), $this->get('config_text'), $this->get('controller.helper'), $this->get('request'), $this->get('template'), $this->get('user'));
    }
    ...
    /**
     * Gets the 'vse.passwordstrength.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\passwordstrength\event\listener A vse\passwordstrength\event\listener instance.
     */
    protected function getVse_Passwordstrength_ListenerService()
    {
        return $this->services['vse.passwordstrength.listener'] = new \vse\passwordstrength\event\listener();
    }

    /**
     * Gets the 'vse.topicpreview.data' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\topicpreview\core\data A vse\topicpreview\core\data instance.
     */
    protected function getVse_Topicpreview_DataService()
    {
        return $this->services['vse.topicpreview.data'] = new \vse\topicpreview\core\data($this->get('config'), $this->get('user'));
    }

    /**
     * Gets the 'vse.topicpreview.display' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\topicpreview\core\display A vse\topicpreview\core\display instance.
     */
    protected function getVse_Topicpreview_DisplayService()
    {
        return $this->services['vse.topicpreview.display'] = new \vse\topicpreview\core\display($this->get('config'), $this->get('dispatcher'), $this->get('template'), $this->get('user'), './', $this->get('vse.topicpreview.trim_tools'));
    }

    /**
     * Gets the 'vse.topicpreview.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\topicpreview\event\listener A vse\topicpreview\event\listener instance.
     */
    protected function getVse_Topicpreview_ListenerService()
    {
        return $this->services['vse.topicpreview.listener'] = new \vse\topicpreview\event\listener($this->get('vse.topicpreview.data'), $this->get('vse.topicpreview.display'));
    }

    /**
     * Gets the 'vse.topicpreview.trim_tools' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\topicpreview\core\trim_tools A vse\topicpreview\core\trim_tools instance.
     */
    protected function getVse_Topicpreview_TrimToolsService()
    {
        return $this->services['vse.topicpreview.trim_tools'] = new \vse\topicpreview\core\trim_tools($this->get('config'));
    }

    /**
     * Gets the 'vse.topicpreview.ucp_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\topicpreview\event\ucp_listener A vse\topicpreview\event\ucp_listener instance.
     */
    protected function getVse_Topicpreview_UcpListenerService()
    {
        return $this->services['vse.topicpreview.ucp_listener'] = new \vse\topicpreview\event\ucp_listener($this->get('config'), $this->get('request'), $this->get('template'), $this->get('user'));
    }
